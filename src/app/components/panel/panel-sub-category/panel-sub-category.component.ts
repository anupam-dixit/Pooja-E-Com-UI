...
declare var $: any;
@Component({
  selector: 'app-panel-sub-category',
  templateUrl: './panel-sub-category.component.html',
  styleUrls: ['./panel-sub-category.component.css']
})
export class PanelSubCategoryComponent {
  ...
  private dtbl() {
    ...
    this.dt=$('#myDataTable').DataTable({
      ...
      ajax: {
        ...
        url:Endpoints.SubCategory.DtList
      },
      columns: [
        { data: 'title' },
        {
